...
class userProfile(models.Model):
    ...
    profile_picture= models.ImageField(upload_to='users/profile_pictures/',null=True,blank=True,default='default/profile-pic.webp')
    ...
    profile_cover= models.ImageField(upload_to="users/bg_image/",blank= True,default='default/bg.jpg')
